...
const HIDE_SIDEBAR_PATHS = ["/", "/intro", "/maintenance", "/more/admin", "/more/admin-dashboard", "/a", "/create-username", "/creator-join", "/creator"]
...
export default function SidebarGate() {
  ...
  const hidePaths = isCreatorPage || HIDE_SIDEBAR_PATHS.some((p) => pathname === p || pathname.startsWith(p + "/"))
