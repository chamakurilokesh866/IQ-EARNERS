...
export default function BlockedGate() {
  ...
  const paperClass = "w-full max-w-md bg-black/80 backdrop-blur-xl text-white rounded-lg border border-white/20 p-6 sm:p-8 animate-pop relative overflow-hidden"
